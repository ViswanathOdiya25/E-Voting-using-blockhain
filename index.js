...
app.get('src/html/aadhar.html', (req, res) => {
  res.sendFile(path.join(__dirname, 'src/html/aadhar.html'))
});

app.get('src/js/aadhar.js', (req, res) => {
  res.sendFile(path.join(__dirname, 'src/js/aadhar.js'))
});

app.get('src/html/signup.html', (req, res) => {
  res.sendFile(path.join(__dirname, 'src/html/signup.html'))
});

app.get('src/js/signup.js', (req, res) => {
  res.sendFile(path.join(__dirname, 'src/js/signup.js'))
});

app.get('src/css/signup.css', (req, res) => {
